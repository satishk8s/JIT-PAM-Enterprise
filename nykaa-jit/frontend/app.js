...
function showPage(pageId) {
    ...
    if (pageId === 'accounts') {
        ...
        loadInstances();
    } else if (pageId === 'dbTerminal') {
        if (typeof refreshDbTerminal === 'function') refreshDbTerminal();
    } else if (pageId === 'vmTerminal') {
        if (typeof refreshVmTerminal === 'function') refreshVmTerminal();
    } else if (pageId === 'containerTerminal') {
        // Container terminal - coming soon, no init needed
    } else if (pageId === 's3') {
        loadS3Buckets();
